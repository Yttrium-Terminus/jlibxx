...
public class Point {
   ...
   * @param y Y coordiante of a point
   * 
   * Constructor creates a new Point instance with user specified coordinates (x,y)
   * in type double
   */
  ...
  /**
   * Overloaded constructor if the user has chosen to specify values that are whole numbers in the range of Integer.MIN_VALUE 
   * to Integer.MAX_VALUE.
   * 
   * There is no casting needed in that integer can be easily converted to a double
   * @see java.lang.Integer.MIN_VALUE
   * @see java.lang.Integer.MAX_VALUE
   * @see java.lang.Double
   * @param x X coordinate of a point (integer)
   * @param y Y coordinate of a point (integer)
   */
  ...
  /**
   * Point constructor incorporates that the user has specificied a valid coordinate in the range of double, however, if necessary
   ...
   * @param x The new x value to be set and overwritten
   */
   ...
   * @param y The new y value to be set and overwritten
   */
  ...
  /**
   * <p>Incorporated calculations that could be done between jlibxx's Point Objects/Instances
